		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>考试方案查询</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
				...
				<option value='2'>老师批阅</option>
								...
								<TD>	状态：
									...
									<TD>										
				<select name="examStaticSchamaPlan" >
				<option value=''>全部</option>
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
									...
									<c:forEach items="${list}" var="li">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='examSchemaAction!examSchemeQuery2?Id_esId=${li.esId}'>${li.esMyselfId}</a>
												</TD>
												...
												<TD class="ItemBody">	${li.tbAuditStatus.asName}
												</TD>
											</TR>
...
{	
    ...
    document.form1.action="examSchemaAction!examSchemeQuery";
	
}

//1 到第一页
function toLastFirst(currentPage){
document.location.href='<%=basePath%>examSchemaAction!examSchemeQuery?pageMethod=first&currentPage='+currentPage; 
   }

//2到第上一页
function toNextPrevious(currentPage){
document.location.href='<%=basePath%>examSchemaAction!examSchemeQuery?pageMethod=previous&currentPage='+currentPage; 
  }

//到第下一页
function toNext(currentPage){

  document.location.href='<%=basePath%>examSchemaAction!examSchemeQuery?pageMethod=next&currentPage='+currentPage; 
...
function toLastEnd(currentPage){
  ...
  document.location.href='<%=basePath%>examSchemaAction!examSchemeQuery?pageMethod=last&currentPage='+currentPage; 
...
function goToPage(){
         ...
         {  
          alert("请正确输入,只能为数字！");  
            ...
            document.location="<%=basePath%>examSchemaAction!examSchemeQuery?pageMethod=goPage&currentPage="+ page;
}
