						...
						<TD>
							...
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										 <font color="#808080" class="">${tes.esMyselfId}</font>
								...
								<TR>
								   ...
								   <TD height="20" width="1%">
									...
									<TD>	<c:forEach items="${tes.tbExamPlans}" var="tbExamPlans">							
										<font color="#808080">${tbExamPlans.tbReadType.rtName }</font>
										</c:forEach>	
									</TD>
									</TR>	
								<TR>
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												...
												<TD class="ItemBody">	${tbDetails.tbTactics.TGetTitleMethod}
												</TD>
							...
							<TABLE align="center" border="0" width="90%">
								<TR>
								   <TD height="20" width="1%">
									...
									<TD>									
										<font color="#808080">${tbAudits.tbUser}</font>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审核时间：
																
										<font color="#808080">${tbAudits.saTime}</font>
									</TD>
									</TR>
								<TR>
									<TD height="20">
									...
									<TD>
                                    <font color="#808080">${tbAudits.saComment}</font>
									</TD>
								</TR>
							</TABLE>
							</c:forEach>
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								...
								<TR>
									...
									<TD>
<TEXTAREA class=box cols=40 name="txtAddress" rows=3>${tes.esId}</TEXTAREA> 
									</TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD>
							...
							<TABLE align="center" border="0" width="90%">
								<TR>
									<TD align="right">
									<input class=button type=button name="bsave" value=" 撤 销 " id="bsave" onclick="toPass()">
...
{	
	if(confirm("确定撤消方案吗？"))
	{
	  ...
	  document.form1.action="examSchemaAction!examSchemeCancel?esMyselfId=${tes.esId}";
...
function toReturn()
{
   document.location.href='examSchemaAction!examSchemeCancel'; 
}
</SCRIPT>