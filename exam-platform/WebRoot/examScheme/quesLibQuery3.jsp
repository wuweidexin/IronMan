		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目信息</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<font color="#808080">${tbP.col1}</font>
									</TD>
									<TD width="12%">	题目类型：
									</TD>
									<TD>										
										<font color="#808080">${tbP.tbProblemType.ptName}</font>
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>
										<font color="#808080">${tbP.tbProblemScore.psName}</font>
									</TD>
									<TD>	题目难度：
									</TD>
									<TD>										
										<font color="#808080">${tbP.tbProblemDifficultyLevel.pdlName}</font>
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>
				                      <font color="#808080">${tbP.tbUser.UName}</font>
									</TD>
									<TD width="12%">	录入日期：
									</TD>
									<TD>										
										<font color="#808080">${tbP.PAddTime}</font>
									</TD>
								</TR>
										<TR>
									<TD height="20">
					...
					<TR>
						<TD>
							<TABLE align="center" border="0" width="90%">
								...
								<TD>	<TEXTAREA class=box  cols="70%" name="question" rows=7 disabled>${tbP.PTitle}</TEXTAREA> 
									</TD>
								</TR>
							</TABLE>
						</TD>
								...
								<TD>	
								   <TABLE align="left" border="0" class="ItemList" height="20" width="83%">
								      <TR height="24" align="middle" >
										...
										<c:forEach items="${tbP.tbProblemResults}" var="li">
											</TR>
