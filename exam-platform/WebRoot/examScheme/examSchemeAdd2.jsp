...
{	
	...
	form1.action="examSchemaAction!examSchemeAdd2?save=1111";
	form1.submit();

}
function toReturn()
{	
	form1.action="examSchemaAction!examSchemeAdd";
	form1.submit();
...
{	
	...
	{
		alert("删除成功！"); 
		form1.action="examSchemaAction!examSchemeAdd2";
		form1.submit();
	}
}
function dddelete()
{	
	...
	{
		alert("删除成功！"); 
		form1.action="examSchemaAction!examSchemeAdd?delete=2222";
		form1.submit();
