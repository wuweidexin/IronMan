   		...
   		<TR>
   			...
   			<TD align="left" valign="top">
   				<TABLE border="0" class="top" width="700">
   					<TR>
   						<TD class="FormTitle" height="2" width="100%">	考试计划信息
   						</TD>
   					</TR>
   					<TR>
   						<TD>	&nbsp;
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
									<font color="#808080">${plan.epMyselfId }</font>
   									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										考试计划名称：
   									
									<font color="#808080">${plan.planName }</font>
   									</TD>
								...
								<TR>
									...
									<TD>
<font color="#808080">${plan.planDescribe }</font>
									</TD>
								</TR>
   							</TABLE>
   						</TD>
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
									...
									<TD width="15%">	班级名称：
   									...
   									<TD width="35%">
									<font color="#808080">${plan.tbClasses.CName }</font>
   									</TD>
									<TD colspan="2">
   									</TD>
   								</TR>
								<TR>
									...
									<TD>	考试时间：
   									...
   									<TD colspan="3">由：
									<font color="#808080">${plan.planStartTime }</font>
   									
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至：
   									
				                  <font color="#808080">${plan.planEndTime }</font>
									</TD>
   								</TR>
								<TR>
   									<TD height="20">
									...
									<TD>	考试方案名称：
   									...
   									<TD>
									<font color="#808080">${plan.tbExamScheme.esName }</font>
   									</TD>
									
									<TD>	批阅截至时间：
   									</TD>
									<TD>
				                  <font color="#808080">${plan.planReadOverTime }</font>
									</TD>
								</TR>
								<TR>
   									<TD height="20">
									...
									<TD>	批阅方式：
   									...
   									<TD>
									<font color="#808080">${plan.tbReadType.rtName }</font>
   									</TD>
									<TD width="15%">	批阅人：
   									</TD>
									<TD>
				                    <font color="#808080">${plan.col3 }</font>
									</TD>
   								</TR>
   							</TABLE>
					</TD>
