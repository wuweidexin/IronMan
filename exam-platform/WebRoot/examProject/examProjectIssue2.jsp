   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
									<font color="#808080">${pi.epMyselfId}</font>
   									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										考试计划名称：
   									
									<font color="#808080">${pi.planName }</font>
   									</TD>
								...
								<TR>
									...
									<TD>
 <font color="#808080">${pi.planDescribe }</font>
									</TD>
								</TR>
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
									...
									<TD width="15%">	班级名称：
   									...
   									<TD width="35%">
									<font color="#808080">${pi.tbClasses.CName }</font>
   									</TD>
									<TD colspan="2">
   									</TD>
   								</TR>
								<TR>
									...
									<TD>	考试时间：
   									...
   									<TD colspan="3">由：
									<font color="#808080">${pi.planStartTime }</font>
   									
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至：
   									
				                  <font color="#808080">${pi.planEndTime }</font>
									</TD>
   								</TR>
								<TR>
   									<TD height="20">
									...
									<TD>	考试方案名称：
   									...
   									<TD>
									<font color="#808080">${pi.tbExamScheme.esName }</font>
   									
									<TD>	批阅截至时间：
   									</TD>
									<TD>
				                  <font color="#808080">${pi.planReadOverTime }</font>
									</TD>
								...
								<TR>
									...
									<TD>	批阅方式：
   									...
   									<TD>
									<font color="#808080">${pi.tbReadType.rtName }</font>
   									</TD>
									<TD width="15%">	批阅人：
   									</TD>
									<TD>
				                    <font color="#808080">${pi.col3 }</font>
									</TD>
   								</TR>
   							</TABLE>
					</TD>
...
{	if(confirm("确定发布该考试计划吗？"))
	{
		alert("考试计划发布成功！"); 
	document.form1.action="examPlanAction!examPlanIssueIssue" ;
