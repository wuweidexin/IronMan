							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href="<%=basePath %>examPlanAction!examPlanCancelNum?epcn=${li.planId}">${li.epMyselfId}</a>
												</TD>
...
function find()
{
	...
	document.form1.action='examPlanAction!examProjectCancel?newHQL=1'; 
...
function clickButton(){ 
		...
		form1.action=" <%=basePath %>examPlanAction!examProjectCancel?pageMethod="+page;
		form1.submit();
}	
function clickButton1(){ 
	
	    document.location.href='<%=basePath %>examPlanAction!examProjectCancel?pageMethod=first&currentPage=${currentPage}';
}	
function clickButton2(){ 
	
	   document.location.href='<%=basePath %>examPlanAction!examProjectCancel?pageMethod=previous&currentPage=${currentPage}';
}	
function clickButton3(){ 
	
	   document.location.href='<%=basePath %>examPlanAction!examProjectCancel?pageMethod=next&currentPage=${currentPage}';
}	
function clickButton4(){ 
	
	   document.location.href='<%=basePath %>examPlanAction!examProjectCancel?pageMethod=last&currentPage=${currentPage}';
}	
</SCRIPT>