					...
					<TR>
						<TD>
							<TABLE align="center" border="0" width="90%">
								...
								<TD>	<TEXTAREA class=box  cols="70%" name="question" rows=7>请输入您要添加的题目</TEXTAREA> 
									</TD>
								</TR>
							</TABLE>
						</TD>
								   ...
								   <TABLE align="left" border="0" class="ItemList" height="20" width="83%">
								      <TR height="24" align="center" >
											...
											<TR align="center" class="ItemBody">
												<TD class="ItemBody" height="20">	<input type="checkbox" id="results" name="results" value="${rl.prId }">
												</TD>
												<TD class="ItemBody" align="left">请添加备选答案
												</TD>
				 ...
				 <TABLE align="center" border="0" width="90%">
							<TR>
									...
									<TD align="center">
        								...
        								<input class=button type="submit" name="Submit223" value="新增备选答案" onclick="toAdd()">
...
function toAdd()
{	
	form1.action='<%=basePath %>problemManagerAction!transeferQuesLibAdd3?pId=${tbProblem.PId}'; 
