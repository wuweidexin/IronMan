...
{	
	...
	{
		alert("增加成功！"); 
		form1.action='<%=basePath %>problemManagerAction!addNewResult?pId=${tbProblem2.PId}'; 
		form1.submit();
	}
}
	...
	function next()
	{	
		document.location.href='<%=basePath %>problemManagerAction!findProblemAndResult?pId=${tbProblem2.PId}'; 
