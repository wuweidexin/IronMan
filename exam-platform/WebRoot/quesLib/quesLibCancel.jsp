							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="center">
											...
											<TR align="center" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='<%=basePath %>problemManagerAction!quesLibCancel2?proNum=${pl.col1}'>${pl.col1}</a>
												</TD>
...
{	
	form1.action='<%=basePath %>problemManagerAction!quesLibCancel?newHQL=1';
	form1.submit();
}
...
function clickButton(){ 
		...
		form1.action="<%=basePath %>problemManagerAction!quesLibCancel?currentPage="+page;
		form1.submit();
}	
function clickButton1(){ 
	
	    document.location.href='<%=basePath %>problemManagerAction!quesLibCancel?pageMethod=first&currentPage=${currentPage}';
}	
function clickButton2(){ 
	
	   document.location.href='<%=basePath %>problemManagerAction!quesLibCancel?pageMethod=previous&currentPage=${currentPage}';
}	
function clickButton3(){ 
	
	   document.location.href='<%=basePath %>problemManagerAction!quesLibCancel?pageMethod=next&currentPage=${currentPage}';
}	
function clickButton4(){ 
	
	   document.location.href='<%=basePath %>problemManagerAction!quesLibCancel?pageMethod=last&currentPage=${currentPage}';
}	
</SCRIPT>