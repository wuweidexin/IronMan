					...
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								<TR>
									<TD height="30"><STRONG>等待批阅的考试计划：</STRONG>
									</TD>
								</TR>
								<TR>
									<TD height="40" width="96%" valign="top">
										<TABLE align="center" border="0" class="ItemList" height="20" width="100%">
											<TR height="24" align="middle">
												...
												<TD class="ItemTitle" width="14%">	考试班级
												</TD>
											...
											<c:if test="${li.tbReadStatus.rsName eq '未批阅'}">
											<TR align="middle" class="ItemBody">
												...
												<TD class="ItemBody">													
													<INPUT type="button" name="joinExam" value="成绩批阅"  onclick="gradeCheck(${li.planId })">
												</TD>
											</TR>
											</c:if>
											</c:forEach>
...
<HR width="98%">
					...
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								<TR>
									<TD height="30"><STRONG>待提交的题库（最后的5题）：</STRONG>
									</TD>
								</TR>
								<TR>
									<TD height="40" width="96%" valign="top">
										<TABLE align="left" border="0" class="ItemList" height="20" width="100%">
											<TR height="24" align="middle">
												<TD class="ItemTitle" height="20" width="14%">	题库编号
												</TD>
												<TD class="ItemTitle" width="14%">	题库类型
												</TD>
												<TD class="ItemTitle" width="14%">	题库范围
												</TD>
											...
											<c:if test="${lip.tbAuditStatus.asName eq '已保存'}">
											<TR align="middle" class="ItemBody">
