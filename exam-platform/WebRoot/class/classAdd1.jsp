						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="gradeName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>										
										<INPUT class=box name="morteaName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>
				<INPUT type="text" name="gradeCreateStart" class="box"  value=''>&nbsp;<A href="javascript:show_calendar('form1.TestTimeaaa');" onmouseout="window.status='';return true;" onmouseover="window.status='Date Picker';return true;"><IMG name="button" src='<%=basePath %>webep/calendar.gif' width=16 height=15 border=0 align="absmiddle"></A>
									</TD>
								</TR>
								<TR>
									<TD height="20">
...
{	
	document.location.href='<%=basePath %>classMangerAction!classAdd1'; 
}
</SCRIPT>