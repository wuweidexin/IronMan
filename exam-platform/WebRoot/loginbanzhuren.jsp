					...
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								<TR>
									<TD height="30"><STRONG>等待发布的考试计划：</STRONG>
									</TD>
								</TR>
								<TR>
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
									    	...
									    	<c:if test="${li.col2 eq '未发布'}" >										
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href='examPlanAction!examPlanIssueNum?epin=${li.planId}'>${li.epMyselfId}</a>
												</TD>
												<TD class="ItemBody" align="left">${li.planName}
												</TD>
												<TD class="ItemBody">${li.planStartTime}——${li.planEndTime}
												</TD>
												<TD class="ItemBody">${li.tbExamScheme.esMyselfId}
												</TD>
												<TD class="ItemBody" align="left">${li.tbClasses.CName}
												</TD>
											...
											<!-- 
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href='examProject\examProjectIssue2.htm'>ISSTCWH_J002_02</a>
												</TD>
												<TD class="ItemBody" align="left">	Java高级编程
												</TD>
												<TD class="ItemBody">	2005-11-20 09:00       －      2005-11-20 11:00
												</TD>
												<TD class="ItemBody">ISSTCWH_S001
												</TD>
												<TD class="ItemBody" align="left">java二班
												</TD>
												<TD class="ItemBody">	2005-12-27 09:00
												</TD>
...
<HR width="98%">
					...
					<TR>
						<TD width="100%">
							<TABLE align="center" width="97%">
								<TR>
									<TD height="30"><STRONG>等待发布的成绩：</STRONG>
									</TD>
								</TR>
								<TR>
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
												...
												<TD class="ItemTitle" width="12%">	考试计划名称
												</TD>
												<TD class="ItemTitle" width="12%">	考试方案名称
												</TD>
												<TD class="ItemTitle" width="12%">	考试时间
												</TD>
											...
											<c:forEach items="${list}" var="li">
											<c:if test="${li.tbPlanStatus.psName eq '未发布'}" >	
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='scoreManagerAction!gradeIssueOne?issueId=${li.planId}'>${li.epMyselfId}</a>
												</TD>
												<TD class="ItemBody" align="left">	${li.planName}
												</TD>
												<TD class="ItemBody">	${li.tbExamScheme.esMyselfId}
											...
											<!-- 
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20"><a href='grade/gradeIssue1.htm'> ISSTCWH_J001_02 </a>
												</TD>
												<TD class="ItemBody" align="left">	Java高级编程
												</TD>
												<TD class="ItemBody">	ISSTCWH_S001
												</TD>
												<TD class="ItemBody">	2005-09-20 09:00－11:00
												</TD>
												<TD class="ItemBody" align="left">	.net 一班
												</TD>
