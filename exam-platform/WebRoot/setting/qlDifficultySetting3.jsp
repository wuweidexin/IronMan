		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目难度维护</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
										<INPUT class="box" name="problemDifficultyLevel.pdlMyselfId" size="20" maxLength="20" value="${qlDifficulty.pdlMyselfId }" type="Text">
   									</TD>
   								</TR>
								<TR>
								    <TD height="20">
								    ...
								    <TD>	题目难度名称：
   									...
   									<TD>
									<INPUT class="box" name="problemDifficultyLevel.pdlName" size="20" maxLength="20" value="${qlDifficulty.pdlName }" type="Text">
   									</TD>
								</TR>
   							</TABLE>
   						</TD>
...
{	
	...
	if(confirm("确定更新题目难度吗？"))
	{
		alert("更新成功！"); 
		form1.action="systemsettingAction!updateQlDifficutly?temp="+${qlDifficulty.pdlId};
		form1.submit();
	}
}
function todelete()
{	
	if(confirm("确定删除题目难度吗？"))
	{
		alert("删除成功！"); 
		form1.action="systemsettingAction!deleteQlDifficutly?temp="+${qlDifficulty.pdlId};
		form1.submit();
	}
}
function next()
{	
	document.location.href='qlDifficultySetting.htm'; 
}
</SCRIPT>