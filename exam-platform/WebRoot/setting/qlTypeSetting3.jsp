		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目类型维护</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
										<INPUT class="box" name="problemType.ptMyselfId" size="20" maxLength="20" value="${ptype.ptMyselfId }" type="Text">
   									</TD>
   								</TR>
								<TR>
								    <TD height="20">
								    ...
								    <TD>	题目类型名称：
   									...
   									<TD>
									<INPUT class="box" name="problemType.ptName" size="20" maxLength="20" value="${ptype.ptName }" type="Text">
   									</TD>
								</TR>
   							</TABLE>
   						</TD>
...
function commit()
{	
	if(confirm("确定更新题目类型吗？"))
	{
		alert("更新成功！"); 
		form1.action="systemsettingAction!updateQlType?qt_id="+${ptype.ptId};
		form1.submit();
	}
}
function todelete()
{	
	if(confirm("确定删除题目类型吗？"))
	{
		alert("删除成功！"); 
		form1.action="systemsettingAction!deleteQlType?qt_id="+${ptype.ptId};
		form1.submit();
	}
}
function next()
{	
	document.location.href='qlTypeSetting.htm'; 
}
</SCRIPT>