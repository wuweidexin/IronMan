		...
		<TR>
			...
			<form action="" name="form1" method="post">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>学生类型查询</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="stNo" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>
<INPUT class=box name="stName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
									<TD class="ItemTitle" height="20" width="14%">	学生类型编号
									</TD>
									<TD class="ItemTitle" width="14%">	学生类型名称
									</TD>
								</TR>
								
								<c:forEach items="${list}" var="li">
								<TR align="middle" class="ItemBody">
									<TD class="ItemBody" height="20"><A href="systemsettingAction!toUpdateStudentType?temp=${li.stId }">${li.stMyselfId }</A>
									</TD>
									<TD class="ItemBody" align="left">	${li.stName }
									</TD>
								</TR>
								</c:forEach>
							<!-- 	<TR align="middle" class="ItemBody">
									<TD class="ItemBody" height="20"><A href="studentTypeSetting2.htm">CT20051028002</A>
									</TD>
									<TD class="ItemBody" align="left">	统招生
									</TD>
								</TR>	 -->							
							</TABLE>
						</TD>
...
function toAdd()
{	
	form1.action="systemsettingAction!toNext?temp=toAddStudentType";
	form1.submit();
}
function toFindWithCon()
{
	...
	form1.action="systemsettingAction!findStudentTypeCondition";
	form1.submit();
