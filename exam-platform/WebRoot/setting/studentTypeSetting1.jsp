		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>学生类型新增</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
							   <tr>
   									...
   									<TD>
										<INPUT class=box name="stMyselfId" size=20 maxLength=20 value="${num }" disabled>
										<INPUT class=box name="studentType.stMyselfId" size=20 maxLength=20 value="${num }" type="hidden">
   									</TD>
   									</tr>
								<TR>
									<TD height="20" width="1%">
									...
									<TD>										
										<INPUT class=box name="studentType.stName" size=20 maxLength=20 value="">
										<c:if test="${temp != null}"><font color='red'>学生类型名称已经存在 </font></c:if>
									</TD>
								</TR>
								...
								<TR>
									...
									<TD align="right">										
										<INPUT class="button" type="button"  name="search" value=" 增 加 " onclick="next()"/>&nbsp;
										<INPUT class="button" type="button"  name="back" value=" 返 回 " onclick="javascript:history.back(-1)"/>
									</TD>
								</TR>
							</TABLE>
						</TD>
...
{	
	...
	if(confirm("确定增加学生类型吗？"))
	{
		form1.action="systemsettingAction!addStudentType";
		form1.submit();
	}
}
</SCRIPT>