		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目难度设置</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
					...
					<TR>
						...
						<form action="" name="form1" method="post">
							...
							<TR>
									...
									<TD>										
										<INPUT class=box name="problemDifficultyLevel.pdlMyselfId" size=20 maxLength=20 value="${num }" disabled>
										<INPUT class=box type="hidden" name="problemDifficultyLevel.pdlMyselfId" size=20 maxLength=20 value="${num }">
									</TD>
								</TR>
								<TR>
									<TD height="20" width="1%">
									...
									<TD>										
										<INPUT class=box name="problemDifficultyLevel.pdlName" size=20 maxLength=20 value="">
										<c:if test="${temp != null}"><font color='red'> 题目难度名称已经存在 </font></c:if>
									</TD>
								</TR>
...
{	for(i=0;i<form1.length;i++){
	...
	form1.action="systemsettingAction!addQlDifficulty";
	form1.submit();
}
</SCRIPT>