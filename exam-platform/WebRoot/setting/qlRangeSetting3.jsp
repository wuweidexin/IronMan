		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目范围维护</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
									<INPUT class="box" name="problemScore.psMyselfId" size="20" maxLength="20" value="${problemScoref.psMyselfId}" type="Text">
   									</TD>
   								</TR>
								<TR>
								    <TD height="20">
								    ...
								    <TD>	题目范围名称：
   									...
   									<TD>
									<INPUT class="box" name="problemScore.psName" size="20" maxLength="20" value="${problemScoref.psName }" type="Text">
   									</TD>
								</TR>
   							</TABLE>
   						</TD>
...
{	
	...
	if(confirm("确定更新题目范围吗？"))
	{
		alert("更新成功！"); 
		form1.action="systemsettingAction!updateQlRange?qlr_id="+${problemScoref.psId};
		form1.submit();
	}
}
function todelete()
{	
	if(confirm("确定删除题目范围吗？"))
	{
		alert("删除成功！"); 
		form1.action="systemsettingAction!deleteQlRange?qlr_id="+${problemScoref.psId};
		form1.submit();
	}
}
function next()
{	
	document.location.href='qlRangeSetting.htm'; 
}
</SCRIPT>