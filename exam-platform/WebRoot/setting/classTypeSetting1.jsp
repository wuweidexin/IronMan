		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>班级类型新增</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="ctMyselfId" size=20 maxLength=20 value="${num }" disabled>
										<INPUT class=box type="hidden" name="classType.ctMyselfId" size=20 maxLength=20 value="${num }">
									</TD>
								</TR>
								<TR>
									<TD height="20" width="1%">
									...
									<TD>										
										<INPUT class=box name="classType.ctName" size=20 maxLength=20 value="">
										<c:if test="${temp != null}"><font color='red'> 班级类型名称已经存在 </font></c:if>
									</TD>
								</TR>
...
{	
	...
	if(confirm("确定增加新班级类型吗？"))
	{
		form1.action="systemsettingAction!addClassType";
		form1.submit();
	} 
}
</SCRIPT>