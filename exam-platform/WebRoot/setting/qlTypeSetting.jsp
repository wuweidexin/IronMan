		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目类型查询</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<form action="" name="form1" method="post">
							<TABLE align="center" border="0" width="90%">
								...
								<TR>
									...
									<TD>
										<INPUT class=box name="examName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
						...
						<TD height="40" valign="top">
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
									<TD class="ItemTitle" height="20" width="14%">	题目类型编号
									</TD>
									<TD class="ItemTitle" width="14%">	题目类型名称
									</TD>
								</TR>
								<c:forEach items="${list}" var="li">
								<TR align="middle" class="ItemBody">
									<TD class="ItemBody" height="20"><A href="systemsettingAction!toUpdateQlType?temp=${li.ptId}">${li.ptMyselfId }</A>
									</TD>
									<TD class="ItemBody" align="left">	${li.ptName }
									</TD>
								</TR>
								</c:forEach>
								<!--  <TR align="middle" class="ItemBody">
									<TD class="ItemBody" height="20"><A href="qlTypeSetting3.htm">	QT20051128002</A>
									</TD>
									<TD class="ItemBody" align="left">	填空题
									</TD>
								</TR>
								-->
							</TABLE>
...
{	
<!--	document.location.href='<>qlTypeSetting2.jsp'; -->
	form1.action="systemsettingAction!toNext?temp=toAddQlType"
	form1.submit();
}
function toFindWithCon()
{
	...
	form1.action="systemsettingAction!findQlTypeCondition"
	form1.submit();
}
function create()
{	
	document.location.href='qlTypeSetting1.htm'; 
}
</SCRIPT>