		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目范围设置</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="psMyselfId" size=20 maxLength=20 value="${num }" disabled>
										<INPUT class=box type="hidden" name="problemScore.psMyselfId" size=20 maxLength=20 value="${num }">
									</TD>
								</TR>
							...
							<TR>
									...
									<TD>										
										<INPUT class=box name="problemScore.psName" size=20 maxLength=20 value="">
										<c:if test="${temp != null}"><font color='red'> 题目范围名称已经存在 </font></c:if>
									</TD>
								</TR><tr></tr>
								<TR>
									<TD height="20">
...
{	
	...
	form1.action="systemsettingAction!addQlRange";
	form1.submit(); 
}
</SCRIPT>