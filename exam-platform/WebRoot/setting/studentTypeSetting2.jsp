		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>学生类型维护</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
   							...
   							<TABLE align="center" border="0" width="90%">
   								<TR>
								    <TD height="20" width="1%">
   									...
   									<TD>
										<INPUT class="box" name="studentType.stMyselfId" size="20" maxLength="20" value="${studentType.stMyselfId}" type="Text">
   									</TD>
   								</TR>
								<TR>
								    <TD height="20">
								    ...
								    <TD>	学生类型名称：
   									...
   									<TD>
									<INPUT class="box" name="studentType.stName" size="20" maxLength="20" value="${studentType.stName}" type="Text">
   									</TD>
								</TR>
   							</TABLE>
   						</TD>
...
{	
	if(confirm("确定更新学生类型吗？"))
	{
		alert("更新成功！"); 
		form1.action="systemsettingAction!updateStudentType?temp="+${studentType.stId};
		form1.submit();
	}
}
function todelete()
{	
	if(confirm("确定删除学生类型吗？"))
	{
		alert("删除成功！"); 
		form1.action="systemsettingAction!deleteStudentType?temp="+${studentType.stId};
		form1.submit();
	}
}
function next()
