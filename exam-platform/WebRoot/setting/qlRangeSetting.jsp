		...
		<TR>
			...
			<TD align="left" valign="top">
				...
				<TABLE border="0" class="top" width="700">
					<TR>
						<TD class="FormTitle" height="2" width="100%"><B>题目范围查询</B>
						</TD>
					</TR>
					<TR>
						<TD>	&nbsp;
						...
						<TD>
							...
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD>										
										<INPUT class=box name="psNo" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
									...
									<TD>
										<INPUT class=box name="psName" size=20 maxLength=20 value="">
									</TD>
								</TR>
								<TR>
									<TD height="20">
						...
						<TD height="40" valign="top">
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
									<TD class="ItemTitle" height="20" width="14%">	题目范围编号
									</TD>
									<TD class="ItemTitle" width="14%">	题目范围名称
									</TD>
								</TR>
								<c:forEach items="${list}" var="li">
								<TR align="middle" class="ItemBody">
									<TD class="ItemBody" height="20"><A href="systemsettingAction!toUpdateQlRange?temp=${li.psId }">${li.psMyselfId }</A>
									</TD>
									<TD class="ItemBody" align="left">	${li.psName }
									</TD>
								</TR>
								</c:forEach>
<!--								<TR align="middle" class="ItemBody">-->
<!--									<TD class="ItemBody" height="20"><A href="qlRangeSetting3.htm">	QR20051128002</A>-->
<!--									</TD>-->
<!--									<TD class="ItemBody" align="left">	java基础-多线程-->
<!--									</TD>-->
<!--								</TR>-->
							</TABLE>
						</TD>
...
function toAdd()
{	
	form1.action="systemsettingAction!toNext?temp=toAddQlRange";
	form1.submit();
}
function toFindWithCon()
{
	...
	form1.action="systemsettingAction!findQlRangeCondition";
	form1.submit();

}
function create()
{	
	document.location.href='qlRangeSetting1.htm'; 
}
</SCRIPT>