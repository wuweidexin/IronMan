			...
			<tr>
				...
				<td width="76%" height="36" bgcolor="#FFFFFF" class="linkBlack">
					<div align="center">
						...
						<form name="form" method="post" action="managerAction!saveManager"
							...
							<table width="58%" border="1" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="77%">
										&nbsp;
										<input name="account" type="text" size="35" value = "${managerID}" disabled = "disabled">
									</td>
								</tr>
								<tr>
									<td height="30">
