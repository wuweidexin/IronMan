				...
				<td width="76%" height="36" bgcolor="#FFFFFF">
					<div align="center">
						...
						<form name="form" method="post"
							action="managerAction!updateManagerMes"
							...
							<table width="58%" border="1" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="77%">
										&nbsp;
										<input name="account" type="text" size="35" disabled="disabled"
											value="${managerAlter.managerID}">
									</td>
								</tr>
								<tr>
									<td height="30">
									...
									<td>
										&nbsp;
										<input name="password" type="managerPassWord" size="35"
											value="${managerAlter.managerPassword}">
									</td>
								</tr>
								<tr>
									<td height="30">
									...
									<td>
										...
										<input name="name" type="text" size="35"
											value="${managerAlter.managerName }">
									</td>
								</tr>
							</table>
							<p>
